...
from tree_parser.tree_v2 import Symbol, Tree, ROOT_ID, SymbolId
from tree_parser.tree_ops import reorder_siblings
from tree_parser.evidence import get_evidence_tta
...
def build(
    ...
    *,
    ...
    from tree_parser.tree_v2 import Node, Edge
...
def _verify_score_gnn(tree: Tree, symbols: list[Symbol], gnn_model, symbol_vocab, device, run_subsets_fn, make_subsets_fn) -> float:
    ...
    from tree_parser.evidence import aggregate_evidence_soft
    from tree_parser.evidence import evidence_to_features
...
def build_with_collapse(
    ...
    *,
    ...
    """
    from tree_parser.tree_v2 import Node, Edge
    from tree_parser.tree_ops import expand
